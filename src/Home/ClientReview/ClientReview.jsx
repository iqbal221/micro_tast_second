...
const ClientReview = () => {
  return (
    <div className="carousel w-full  mb-16  ">
      ...
      >
        <div className="absolute lg:w-[800px] w-[220px] text-center text-white">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 lg:left-20 left-5 lg:right-20 right-5 top-1/2">
